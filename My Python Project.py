...
import math
def phi(zval):
        #This function returns the probability associated with the z value
        z_score = {
...
'''
def normal(mean,s_d,x,y):
    z_score1 = x-mean/s_d
    z_score2 = y-mean/s_d
    if z_score1 or z_score2 < 0:
        p_down = phi(abs(z_score1)) + phi(abs(z_score2)) - 1
    elif z_score1 == z_score2 and z_score1 == -z_score2:
